...
<body>
  <nav>
    ...
    <ul class="menu">
      <li><a href="index.php">Home Menu</a><i class="bi bi-dash"></i></li>
      <li><a href="kriteria.php">Input Kriteria</a><i class="bi bi-dash"></i></li>
      <li><a href="alternatif.php">Input Alternatif</a><i class="bi bi-dash"></i></li>
      ...
      <li><a href="hasil.php">Perankingan</a></li>
    </ul>
  </nav>
